...
Instead of installing a different library for every microscope brand, we recommend BIOIO. It acts as a consistent interface for almost any biological image format, allowing you to use the same commands regardless of the file source. You can have a look at what file formats are supported by BIOIO [here](https://bioio-devs.github.io/bioio/OVERVIEW.html#reader-installation).
